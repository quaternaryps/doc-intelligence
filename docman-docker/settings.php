...
$databases = array (
  ...
  array (
    ...
    array (
      ...
      'password' => getenv('DRUPAL_DB_PASSWORD') ?: 'changeme',
 ...
 *
 */
$drupal_hash_salt = 'JipU9X2FgJ_YcejXQ1BUDw5sSnW-fXpqnhH3jx7BQq0';
...
/**
 * Suppress PHP 8.1 deprecation warnings for production
 * Added: January 9, 2026
 * Reason: Legacy Entity module compatibility
 */
error_reporting(E_ALL & ~E_DEPRECATED & ~E_STRICT);
ini_set('display_errors', 0);
ini_set('log_errors', 1);
ini_set('error_log', '/var/www/html/sites/default/files/php-errors.log');
